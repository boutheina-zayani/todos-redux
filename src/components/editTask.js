...
import { handleEdit } from '../JS/actions';
    ...
    const EditTask=({el})=>{
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" onClick={handleShow} style={{fill: "blue"}}>
